...
function getTypeDefinition(gqlType: GraphQLOutputType, factory: TypeDefinitionFactory, selectionSet?: SelectionSetNode, nullable = true): TypeDefinition {
        ...
        if (selectionSet) {
            ...
            objType.members.push(
                factory.createObjectMemberDefinition(
                    "__typename",
                    factory.createIntrinsicDefinition(IntrinsicTypes.String),
                )
            );
